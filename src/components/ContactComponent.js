...
class Contact extends Component {  
    ...
    handleSubmit(values) {
        ...
        this.props.postFeedback(values.firstname, values.lastname, values.telnum, values.email, values.message, values.contactType, values.agree);
                    ...
                    <Form model="feedback" onSubmit={(values) => this.handleSubmit(values)}>
                            ...
                            <Row className="form-group">
                                ...
                                <Control.textarea model=".message" id="message" name="message"
                                        ...
                                        className="form-control"
                                        validators={{
                                            required, minLenght: minLenght(80), maxLenght: maxLenght(120)
                                        }}
                                        />
                                        <Errors 
                                            className="text-danger"
                                            ...
                                            messages={{
                                                required: 'Required',
                                                minLenght: 'Must be grater than 80 charachters',
                                                maxLenght: 'Must be 120 charachters or less'
                                            }}
                                        />
                                </Col>
                            </Row>
